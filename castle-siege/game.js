(() => {
 ...
 function map(){
  ...
  for(let y=0;y<11;y++)for(let x=0;x<11;x++){
   ...
   const cell=document.createElement(lane?'button':'div');if(lane)cell.type='button';cell.className='cell';cell.dataset.x=x+1;cell.dataset.y=y+1;cell.title='X'+(x+1)+', Y'+(y+1);
